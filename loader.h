...
for(i=0;i<Facen;i++){
 glBegin(GL_TRIANGLES);
  ...
  glTexCoord2f(Textures[0][FacesTex[0][i]-1],1-Textures[1][FacesTex[0][i]-1]);
  ...
  glTexCoord2f(Textures[0][FacesTex[1][i]-1],1-Textures[1][FacesTex[1][i]-1]);
  ...
  glTexCoord2f(Textures[0][FacesTex[2][i]-1],1-Textures[1][FacesTex[2][i]-1]);
...
bool ReadFiles()
{
        Human.Set("Data\\Models\\human.ini");
        Human.LoadFile();
        Land.Set("Data\\Terrain\\001.ini");
        Land.LoadFile();
        Font1.Create();
// FontListID = CreateOpenGL3DFont("CyrillicGoth", FONT_EXTRUDE);
//        LoadRawFile("Data\\Terrain\\001.raw",1);
//        InitTex("Data\\Textures\\001.bmp",0);
//        InitTex("Data\\Textures\\001d.bmp",1);
// InitTex("Data\\Textures\\spark.bmp",0);
// InitTex("Data\\Textures\\test.bmp",1);
//        LoadFile("Data\\Models\\run.gms",1,12,50);
//        Texture.Load("Data\\Textures\\metall.bmp");
//        Texture.Select();
//FontListID = CreateOpenGL3DFont("Courier", FONT_EXTRUDE);
//FontListID = CreateOpenGL3DFont("Data\\Fonts\\cyrillic_goth_normal.ttf", FONT_EXTRUDE);
//FontListID = CreateOpenGL3DFont("DrPoDecorRu", FONT_EXTRUDE);
